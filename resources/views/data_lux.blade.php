                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="card mb-4">
                                            <div class="card-header">
                                                <h6 class="m-0 font-weight-bold text-primary">Datos del Sensor Luminosidad</h6>
                                            </div>
                                            <div class="card-body">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @forelse ($data as $item)
                                                            <tr>
                                                                ...
                                                                <td>{{ $item->lux }}</td>
                                                                <td>{{ $item->status_read_sensor_lux }}</td>
                                                                <td>{{ $item->time }}</td>
                                                                <td>{{ $item->date }}</td>
                                                            </tr>
                                                        @empty
                                    ...
                                    <div class="col-md-6">
                                        <div class="card mb-4">
                                            <div class="card-header">
                                                <h6 class="m-0 font-weight-bold text-primary">Gráfico de Luminosidad</h6>
                                            </div>
                                            <div class="card-body">
